...
import awsecommerceservice.models.related_items_3
...
import awsecommerceservice.models.variations_3
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('RelatedItems') != None:
            ...
            for structure in dictionary.get('RelatedItems'):
                related_items.append(awsecommerceservice.models.related_items_3.RelatedItems3.from_dictionary(structure))
        ...
        variations = awsecommerceservice.models.variations_3.Variations3.from_dictionary(dictionary.get('Variations')) if dictionary.get('Variations') else None
